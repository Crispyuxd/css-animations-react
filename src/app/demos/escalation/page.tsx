  ...
  return (
    <ChatCard>
      ...
      <MessagesStack>
        ...
        <BotMessage id="bot-3" meta={<MetaRow id="meta-2" author="Mark Kent" />}>
        ...
        <BotMessage id="bot-4" meta={<MetaRow id="meta-3" author="Mark Kent" />}>
          Let me pull up your order. Give me just a moment.
        </BotMessage>
      </MessagesStack>
      <ChatInput />
    </ChatCard>
