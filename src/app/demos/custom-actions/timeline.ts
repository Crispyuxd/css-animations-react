...
// Layout reference (offsetTop within #custom-actions-scroll, gap 20 +
...
export const timeline: TimelineConfig = {
  ...
  steps: [
    ...
    // Bot-2 response — 2 lines at streaming pace. meta-1 holds for
    // 3.6s at the end of the cycle so the final frame breathes.
    { type: 'bot', id: 'bot-2', lines: [57, 27], cps: 45, accel: 1, pause: '0.36s',
